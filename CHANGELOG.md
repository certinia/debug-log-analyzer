...
- 📄 **Unreadable log**: folding, symbols and line timings went quiet on a log that could not be read or parsed. The reason now goes to the Apex Log Analyzer output channel.
