...
- 🧭 **Inspector**: select a timeline frame, a table row or a statement to see its details, governor usage, call stack and subtree - or select nothing for a whole-log overview. Dock it left, right or bottom, drag a section header to reorder it, and right-click one to choose which sections show. ([#113] [#373] [#63])
