...
- 📄 **Unreadable log**: folding, symbols and line timings went quiet on a log that could not be read or parsed. The Apex Log Analyzer output channel now opens once per log and says why.
