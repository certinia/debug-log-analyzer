...
- 📐 **Arrange the Inspector**: drag a section header to reorder it, or press `Alt+Up` / `Alt+Down`; right-click a header to choose which sections show; drag a divider to resize. Each tab keeps its own arrangement. ([#373])
