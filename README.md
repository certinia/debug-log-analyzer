...
- **Nothing selected?** – It shows the whole log: the governor metrics closest to their limits, and on the Timeline tab, time by category, governor usage over time and the full call tree.
