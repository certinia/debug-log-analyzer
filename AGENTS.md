...
- `.claude/rules/log-viewer.md` — webview/UI: boundary, performance budgets, appearance tokens and
  live re-theme (`--lana-*`, `ThemeObserver`, flat vs cards chrome), key paths.
- `.claude/rules/lana.md` — VS Code extension: UX, settings/appearance signals, command paths.
