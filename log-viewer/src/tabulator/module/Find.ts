...
export class Find extends Module {
  ...
  _runFormatterForColumn(
    ...
    // extractable text. This happens for custom-element HTML strings whose
    // content renders via shadow DOM — in a detached element they never
    // connect, so textContent is empty.
