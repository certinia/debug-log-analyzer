...
description: A step-by-step guide to installing, configuring, and using the Apex Log Analyzer extension for Visual Studio Code to analyze Salesforce Apex debug logs efficiently.
keywords: [
...
On larger logs the analysis window may take a few seconds to appear.
...
1. Click the 'Log: Show Apex Log Analysis' code lens at the top of the file\
   <img
     src="https://raw.githubusercontent.com/certinia/debug-log-analyzer/main/lana/assets/1_22/vscode/show-analysis-lens.webp"
