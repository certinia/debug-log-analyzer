...
- **Extensions sidebar** — search for `Apex Log Analyzer` and click **Install**, or <a className="button button--primary button--sm" href="vscode:extension/financialforce.lana">Open in VS Code</a>
