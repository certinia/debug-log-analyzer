...
![The inspector on the Analysis tab, showing the selected method's details, the findings that name it, its call stack and its scoped call tree.](https://raw.githubusercontent.com/certinia/debug-log-analyzer/main/lana/assets/1_22/inspector.png)
